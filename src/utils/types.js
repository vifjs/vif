 ...
 * @callback VIF.Element.Datas.Reference Function used to apply effects to a DOM reference
 ...
 * @callback VIF.Element.DisconnectCallback Function used to clear signals dependencies: enabled on xManager, xElement and xReactive
 ...
 */
/** - Directive
 * @callback VIF.Directive Function creating a reactive function
 ...
 */
/** - Expression
 * @callback VIF.Expression Function generated from string with the evaluator
 ...
 */
/** - Reactive
 * @callback VIF.Reactive Function running everytime a containing signal value change
 * @property {VIF.Dependencies.Signals} signals All signals dependencies containing that reactive function
 * @returns {any}
 */
/** - Signal
 * @callback VIF.Signal Function used to get or change value rerunning dependencies functions
 ...
 */
/** - Define
 * @callback VIF.Method.Define Function used to define a customElement
 ...
 */
/** - Define.Render
 * @callback VIF.Method.Define.Render Function used to hydrate datas and create component template & schema
 ...
 */
/** - Define.Render.HTML
 * @callback VIF.Method.Define.Render.HTML Function used to create html template
 * @param {string?} templateLiteral String representation of html template
 * @returns {VIF.Template|null} The component template
 */
/** - Define.Render.CSS
 * @callback VIF.Method.Define.Render.CSS Function used to create css template and also define css selectors
 ...
 */
/** - Signal
 * @callback VIF.Method.Signal Function used to create a signal that can trigger changes through reactives functions
 * @param {any?} value Default value of signal data
 * @returns {VIF.Signal} A signal that can be used to create reactive variables
 */
/** - Navigate
 * @callback VIF.Method.Navigate Function used to navigate between routes with browser history
 ...
 */
/** - Observe
 * @callback VIF.Method.Observe Function used to observe the first addition of an x-element to the DOM
